...
with pkgs.tmuxPlugins; [
  ...
  tmux-fzf
  {
    ...
    extraConfig = ''
      ...
      set -ag status-right "#[bg=#{@thm_yellow},fg=#{@thm_crust}]#(/nix/store/w0d4ir5cf4xszc030547ahqkvvl3ypws-source/scripts/battery-icon.sh) "
      set -ag status-right "#[fg=#{@thm_fg},bg=#{@thm_surface_0}] #(/nix/store/w0d4ir5cf4xszc030547ahqkvvl3ypws-source/scripts/battery-capacity.sh)% "
